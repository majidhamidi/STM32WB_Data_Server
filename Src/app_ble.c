...
static void LinkConfiguration(void)
{
  ...
  status = hci_le_set_data_length(BleApplicationContext.BleApplicationContext_legacy.connectionHandle,250,2112); ///////////////////////////////////sets ATT_MTU!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification( void *pckt )
{
  ...
  debugc[0]=(uint32_t)(event_pckt->evt);
  debugc[1]=(uint32_t)((evt_le_meta_event*) event_pckt->data);
